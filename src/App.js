        ...
        {this.state.showSearchPage ? (
          ...
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>
                <BookShelf books={books.filter(book=>book.shelf==='currentlyReading')} shelfName='Currently Reading'/>
                <BookShelf books={books.filter(book=>book.shelf==='wantToRead')} shelfName='Want To Read' />
                <BookShelf books={books.filter(book=>book.shelf==='read')} shelfName='Read'/>
              </div>
            </div>
